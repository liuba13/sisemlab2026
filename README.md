...
##Про проєкт
  ...
  Розроблено для дисципліни Серверні інформаційні системи екологічного моніторингу
  
  Детальніше про [кафедру цифрових технологій в енергетиці КПІ ім. Ігоря Сікорського](https://dte.kpi.ua)
